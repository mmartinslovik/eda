...
import com.example.atm.serdes.AmountWasDepositedSerializer;
...
public class KafkaConfig {
    ...
    public ProducerFactory<String, Event> producerFactory() {
        ...
        configProps.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, AmountWasDepositedSerializer.class);
